...
<p>Laptops are used in a variety of settings, such as at work (especially on business trips), in education, for playing games, content creating, web browsing, for personal multimedia, and for general home computer use. They can run on both AC power and built-in rechargable batteries, and can be folded shut for convenient storage and transportation, making them suitable for mobile use.[3] Laptops combine essentially the same input/output components and capabilities of a desktop computer into a single unit, including a display screen (usually 11–17 in or 280–430 mm in diagonal size), small speakers, a keyboard, and a pointing device (usually touchpads). Hardware specifications may vary significantly between different types, models, and price points.</p>

# Types of laptops

[Wikipedia source here](https://en.wikipedia.org/wiki/Laptop)
...
# Hardware
*Further information: [Personal computer](https://en.wikipedia.org/wiki/Personal_computer) and [Computer hardware](https://en.wikipedia.org/wiki/Computer_hardware)*
...
3. storage
4. [motherboard](https://en.wikipedia.org/wiki/Motherboard)
5. battery
